      ...
      <view class="card">
        ...
        <view class="info-grid">
          ...
          <view class="info-item">
            ...
            <text class="info-value">{{ ret.external_invoice_no || '-' }}</text>
          </view>
          <view class="info-item">
          ...
          <view class="info-item">
            <text class="info-label">采购单金额</text>
          ...
          <view class="info-item">
            ...
            <text class="info-value date-text">{{ formatDate(ret.invoice_date) }}</text>
          </view>
          <view class="info-item">
...
const previewImage = (url) => {
  if (isImageUrl(url)) {
    ...
    // Open document link or show url
...
const loadDetail = async () => {
  ...
  loading.value = true
  try {
    const res = await purchaseApi.getInvoiceDetail(id)
    if (res.code === 0) {
      ret.value = res.data || {}
    }
  } catch (e) {
