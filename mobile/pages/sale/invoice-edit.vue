        ...
        <view class="section">
          ...
          <view class="form-group">
            <view class="form-item">
              <text class="form-label required">选择销售单</text>
            ...
            <view class="form-item">
              ...
              <text class="product-info-text">{{ customerName || '-' }}</text>
            </view>
            <view class="form-item">
...
const handleSave = async () => {
  if (!form.order_id) {
    uni.showToast({ title: '请选择销售订单', icon: 'none' })
    return
  }
  ...
  try {
    ...
    const res = await saleApi.createInvoice(payload)
    if (res.code === 0) {
