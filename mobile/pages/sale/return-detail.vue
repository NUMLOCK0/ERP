<template>
  <view class="return-detail">
    <view v-if="ret.id" class="detail-content">
      ...
      <view class="card">
        ...
        <view class="info-grid">
          <view class="info-item">
            ...
            <text class="info-value font-bold">{{ ret.return_no }}</text>
          </view>
          <view class="info-item">
          ...
          <view class="info-item">
            <text class="info-label">关联发货单</text>
      ...
      <!-- 物流及收货信息 -->
      <view class="card">
        <view class="card-title">联系与物流信息</view>
        <view class="info-grid">
          <view class="info-item">
          ...
          <view class="info-item" style="width: 100%;" v-if="ret.express_name || ret.express_no">
            <text class="info-label">物流信息</text>
            <text class="info-value">{{ ret.express_name || '-' }} (单号: {{ ret.express_no || '-' }})</text>
          </view>
        </view>
      </view>

      <!-- 退货原因 -->
      <view class="card" v-if="ret.reason">
        <view class="card-title">退货原因/备注</view>
      ...
      <!-- 商品明细 -->
      <view class="card">
        <view class="card-title">退货商品明细</view>
        <view class="item-list">
          ...
          <view class="item-row" v-for="(item, index) in ret.items" :key="index">
            <view class="col-name">
              ...
              <text class="p-spec" v-if="item.spec || item.code">规格: {{ item.spec || '-' }} ({{ item.code || '-' }})</text>
            </view>
