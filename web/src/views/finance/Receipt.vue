<template>
  <div class="page-container">
    <el-card>
      <div class="toolbar">
        <el-button type="primary" :icon="Plus" @click="ElMessage.info('新增收款单')">新增收款单</el-button>
      </div>
      <SearchForm :model="searchForm" @search="handleSearch" @reset="handleReset">
        <el-form-item label="收款单号"><el-input v-model="searchForm.receipt_no" placeholder="收款单号" clearable /></el-form-item>
      ...
      <el-table :data="tableData" stripe v-loading="loading">
        <el-table-column prop="receipt_no" label="收款单号" width="180" />
        <el-table-column prop="customer_name" label="客户" min-width="150" />
        <el-table-column prop="delivery_no" label="关联发货单" width="180" />
...
const searchForm = reactive({ receipt_no: '', customer_id: null as any })
...
function handleReset() { Object.assign(searchForm, { receipt_no: '', customer_id: null }); handleSearch() }
