  ...
  <div class="page-container">
    <el-card>
      ...
      <el-table :data="tableData" stripe v-loading="loading">
        <el-table-column prop="payment_no" label="付款单号" width="190">
          <template #default="{ row }"><CopyableNo :value="row.payment_no" /></template>
        </el-table-column>
...
import { getPurchasePaymentReport } from '@/api/report'
...
async function fetchData() {
  ...
  try {
    ...
    const res: any = await getPurchasePaymentReport(p)
